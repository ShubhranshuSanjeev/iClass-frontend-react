...
class Classroom extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.is_teacher) this.setState({ ...this.state, joinRequests: false, settings: false })
  }
              ...
              <div className={`${styles.classroomWrapper} d-flex justify-content-around`}>
                ...
                <div className={`${styles.classroomContent} p-4`}>
                  <div className="content-header">
                    ...
                    <p className={`${styles.courseName}`} style={{ fontSize: "12px" }}>Room Number: {classroom.room_number}</p>
                    <hr />
                  </div>
                  {
                    /** 
