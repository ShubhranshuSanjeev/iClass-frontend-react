			...
			return (
				<Link to="/join-classroom">
					<div className="card" style={{ position: "relative" }}>
						...
						<div
							className="overlay h-100 w-100 d-flex justify-content-center align-items-center flex-column"
							style={{
								position: "absolute",
								top: "0",
								left: "0",
								backgroundColor: "rgba(207, 204, 255, 0.5)",
							}}
						>
							<span
...
const mapStateToProps = state => {
	...
	return {
		classrooms: Object.values(state.classrooms),
		is_student,
		is_teacher,
	};
};
